...
set_target_properties(clangSema PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "clangAPINotes;clangAST;clangAnalysis;clangBasic;clangEdit;clangLex;clangSupport;LLVMCore;LLVMDemangle;LLVMFrontendHLSL;LLVMFrontendOpenMP;LLVMMC;LLVMSupport;LLVMTargetParser"
...
set_target_properties(clangExtractAPI PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "clangAST;clangBasic;clangFrontend;clangIndex;clangInstallAPI;clangLex;LLVMSupport;LLVMTargetParser"
...
set_target_properties(clangInstallAPI PROPERTIES
  IMPORTED_IMPLIB_MINSIZEREL "${_IMPORT_PREFIX}/lib/libclangInstallAPI.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "clangAST;clangBasic;clangLex;LLVMSupport;LLVMTextAPI;LLVMTextAPIBinaryReader;LLVMDemangle;LLVMCore"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/libclangInstallAPI.dll"
  )

list(APPEND _cmake_import_check_targets clangInstallAPI )
list(APPEND _cmake_import_check_files_for_clangInstallAPI "${_IMPORT_PREFIX}/lib/libclangInstallAPI.dll.a" "${_IMPORT_PREFIX}/bin/libclangInstallAPI.dll" )
...
set_target_properties(clangTidyMiscModule PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "clangTidy;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAnalysis;clangAST;clangASTMatchers;clangBasic;clangFormat;clangLex;clangSerialization;clangTooling;clangToolingInclusions;clangToolingInclusionsStdlib;clangIncludeCleaner"
...
set_target_properties(clangPseudoCXX PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "clangPseudo;clangPseudoGrammar;LLVMSupport;clangBasic"
...
set_target_properties(clangPseudo PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "clangPseudoGrammar;LLVMSupport;clangBasic;clangLex"
...
set_target_properties(clangdMain PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVMSupport;LLVMX86Info;LLVMARMInfo;LLVMAArch64Info;LLVMNVPTXInfo;LLVMAMDGPUInfo;LLVMWebAssemblyInfo;LLVMFrontendOpenMP;LLVMOption;LLVMTargetParser;clangAST;clangBasic;clangFormat;clangFrontend;clangTooling;clangToolingSyntax;clangTidy;clangTidyUtils;clangDaemon;clangdRemoteIndex;clangdSupport"
